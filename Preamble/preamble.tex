...
\usepackage{color}
\usepackage[suppress]{sty/color-edits}
%The predefined color names are: black, blue, brown, cyan, darkgray, gray, green, lightgray, lime, magenta, olive, orange, pink, purple, red, teal, violet, white, yellow.
% Define yourself by using \addauthor{initials}{colour}
% This creates \{initials}comment|edit|delete to mark each type of interaction
\addauthor{ZT}{olive} % Zeerak Talat
...
% Allow for pushing tables onto different page.
...
% Emojis
\usepackage{sty/emoji}
\newcommand{\parrot}{\emoji[Figs]{parrot1f99c}}