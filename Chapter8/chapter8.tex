...
The contributions in this dissertation are thus in part \ZTdelete{of theoretical nature and in part of experimental nature}\ZTedit{theoretical and in part experimental in nature}.
...
\ZTdelete{The research questions I address in this dissertation are:}
...
\ZTedit{One challenge that is raised in \cref{chap:dirt} is the notion of the pluralist model that Opt Out develop.
While a pluralist model does allow for people embed their own subjectivities into the modelling process, they are not exempt from the critiques made in \cref{chap:dirt}.
...
\ZTedit{In seeking answers to the guiding questions, my work in this dissertation both fails to achieve the research goals and manages to fulfil them.
...
\ZTedit{ % Dirt
  Moreover, my chapter on content moderation and social pollution (see \cref{chap:dirt}) provides a next step, expanding on \citet{Liboiron:2018}.
