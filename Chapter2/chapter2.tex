...
\ZTcomment{Add references on intermediary liability law}
...
In the law of the United States of America, the concept of freedom of speech has very few limits, in contrast to the European notion of freedom of speech, which has much greater restrictions \citep{Banks:2016.}}
...
Interested parties can see research and organisations that more specifically deal with the legal landscape for online intermediaries \citet[e.g.]{...} and section 230 specifically \citet[e.g.]{EFF:n.d.;Defterderian_2009;Goldman_2018;Sheridan_1997;Ardia_2010;Leary_2018}.
}
...
\begin{enumerate}
  \item{The bills \ZTdelete{weaken}\ZTedit{seek to undermine} \citep{Romano:2018,Stryker:2018} \ZTdelete{in} Section 230 of the Communications Decency Act (CDA) by holding \ZTdelete{ - which holds} that computer service providers are not publishers and thus not liable for content on the platform \citep{EFF:230}},
...
An imaginable configuration for this could be that data is never released, however researchers can submit models and code to train and evaluate on the dataset.
...
Consider for a moment dog-whistles \citep{...}, the coded language that is used to target specific demographic groups, the specific group that is being targeted may be the only group that can correctly identify a speech act as abusive or hateful.
...
Recruiting people to annotate abuse and hateful speech targeted towards their own identities also means exposing them to violence that specifically targets them, which may make the issue of vicarious trauma even more acute \citep{...}.}
...
As \citet{Waseem:2018} indicate and \citet{Davidson:2019} and \citet{Dias:2020} lay clear, there are significant racialised issues with classification of abuse, leading to African American English speakers and queer folks being censored through a disproportionate amount of false positives.
