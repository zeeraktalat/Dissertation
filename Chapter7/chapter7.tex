...
\section{Discussion}
\ZTcomment{Asked to update and make less terse}
\ZTcomment{Make two additional points:}
\ZTcomment{1. How to move away from the focus on designing systems for the designers of the systems: e.g. participatory design - also think about how to make it not predatory.}
\ZTcomment{2. Add a consideration of the political economy of content moderation and machine learning - as a way to address the large focus on the designers of systems and contextualise their role in the social systems machine learning systems are embedded in.}
\ZTcomment{Add an argument for the implications this has for computational modelling - where do we go from here, why is this important, what is the impact of my considerations?}
