...
\begin{quote}
  ``So hate speech detection is kind of like sentiment analysis++'' -- ACL 2016 Conference Attendee\footnote{Check with AJ that I can attribute.}
\end{quote}
...
In the context of machine learning for online abuse, these overlaps make it relevant to ask how such overlaps influence the task of predicting online abuse and which tasks contain inductive biases that improve model performances.
