...
I include this dataset because sarcasm, irony, and humour have previously been identified as confounding factors to abuse detection \citep{Rottger:2021} that can result in classification errors due to automated methods examining literally what is meant to communicate a message figuratively.
Thus, through this auxiliary task, MTL models learn representations of how sarcasm is constituted within \textit{Sarcasm} dataset, in addition to the other auxiliary tasks, and the main task.
