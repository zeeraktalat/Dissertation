...
\zw{Explain training regime}
- Multiple epochs
- shuffle between each epoch
- evaluate on main task dev data
- Explain how we do early stopping
...
\begin{tabular}{lllll|llll}
                    & \multicolumn{4}{c}{Onehot input layer} & \multicolumn{4}{c}{Embedding input layer} \\\hline
                    & MLP     & RNN     & LSTM     & CNN     & MLP      & RNN      & LSTM      & CNN     \\
Hidden Dimension    &         &         &          &         &          &          &           &         \\
Embedding Dimension &         &         &          &         &          &          &           &         \\
Activation Function &         &         &          &         &          &          &           &         \\
Batch Size          &         &         &          &         &          &          &           &         \\
