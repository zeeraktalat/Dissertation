...
\begin{table}[]
  ...
  \caption{Experimental model validation scores on the \textit{Hate Speech} dataset. \textbf{bolded} scores indicate the highest performances and $\sigma$ values indicate the standard deviation.}
