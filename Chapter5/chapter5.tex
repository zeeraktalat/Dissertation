...
Turning to the performance on the test sets, the results presented in \cref{tab:mtl_test_wh,tab:mtl_test_davidson,tab:mtl_test_wulczyn} are the mean of five runs with different random seeds.

\begin{table}[]
  \centering
  \begin{tabular}{l|llll}
                                      & Accuracy                          & Precision                         & Recall                            & F1-score                 \\
    Waseem                            & $0.8082 (\sigma 0.0098)$          & $0.7496 (\sigma 0.0117)$          & $0.7661 (\sigma 0.0153)$          & $0.7564 (\sigma 0.0044)$          \\
    Davidson                          & $0.8194 (\sigma 0.0047)$          & $0.7001 (\sigma 0.0181)$          & $\mathbf{0.8204} (\sigma 0.0069)$ & $0.7430 (\sigma 0.0124)$          \\
    Wulczyn                           & $0.8105 (\sigma 0.0075)$          & $0.7236 (\sigma 0.0244)$          & $0.7779 (\sigma 0.0184)$          & $0.7424 (\sigma 0.0165)$          \\
    Moral                             & $0.8234 (\sigma 0.0024)$          & $0.7302 (\sigma 0.0120)$          & $0.8039 (\sigma 0.0079)$          & $0.7595 (\sigma 0.0067)$          \\
    Factfeel                          & $0.8141 (\sigma 0.0090)$          & $0.7380 (\sigma 0.0185)$          & $0.7744 (\sigma 0.0228)$          & $0.7489 (\sigma 0.0146)$          \\
    Sarcasm                           & $0.8192 (\sigma 0.0018)$          & $0.7262 (\sigma 0.0167)$          & $0.7993 (\sigma 0.0145)$          & $0.7548 (\sigma 0.0065)$          \\
    Waseem Moral                      & $0.8173 (\sigma 0.0071)$          & $0.7366 (\sigma 0.0089)$          & $0.7882 (\sigma 0.0191)$          & $0.7523 (\sigma 0.0100)$          \\
    Davidson Moral                    & $0.7985 (\sigma 0.0090)$          & $0.6994 (\sigma 0.0240)$          & $0.7628 (\sigma 0.0155)$          & $0.7244 (\sigma 0.0163)$          \\
    Waseem Davidson                   & $0.8147 (\sigma 0.0053)$          & $0.7294 (\sigma 0.0222)$          & $0.7845 (\sigma 0.0184)$          & $0.7505 (\sigma 0.0070)$          \\
    Sarcasm Waseem                    & $\mathbf{0.8253} (\sigma 0.0079)$ & $0.7333 (\sigma 0.0277)$          & $0.8096 (\sigma 0.0167)$          & $0.7618 (\sigma 0.0171)$          \\
    Sarcasm Davidson                  & $0.8182 (\sigma 0.0051)$          & $0.7186 (\sigma 0.0266)$          & $0.8031 (\sigma 0.0139)$          & $0.7518 (\sigma 0.0160)$          \\
    Sarcasm Moral                     & $0.8215 (\sigma 0.0071)$          & $0.7209 (\sigma 0.0231)$          & $0.8108 (\sigma 0.0101)$          & $0.7548 (\sigma 0.0164)$          \\
    Waseem Davidson Moral             & $0.7901 (\sigma 0.0176)$          & $0.7488 (\sigma 0.0057)$          & $0.7366 (\sigma 0.0227)$          & $0.7407 (\sigma 0.0153)$          \\
    Sarcasm Waseem Moral              & $0.8180 (\sigma 0.0071)$          & $0.7129 (\sigma 0.0222)$          & $0.8016 (\sigma 0.0046)$          & $0.7473 (\sigma 0.0166)$          \\
    Sarcasm Davidson Moral            & $0.8151 (\sigma 0.0066)$          & $\mathbf{0.7502} (\sigma 0.0070)$ & $0.7762 (\sigma 0.0103)$          & $\mathbf{0.7623} (\sigma 0.0051)$ \\
    Sarcasm Waseem Davidson Moral     & $0.8124 (\sigma 0.0101)$          & $0.6898 (\sigma 0.0221)$          & $0.8142 (\sigma 0.0053)$          & $0.7278 (\sigma 0.0234)$
  \end{tabular}
