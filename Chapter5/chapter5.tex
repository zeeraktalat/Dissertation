...
For the linear baseline models, I tokenise and pre-process the data and perform a grid-search over \ZTdelete{the}\ZTedit{a} parameter space \ZTdelete{that}\ZTedit{in search of the parameter values that} optimises for the highest macro F1-score performance.
