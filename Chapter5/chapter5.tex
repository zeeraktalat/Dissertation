...
Similarly to the pattern for the baseline models optimised for the \textit{Hate Speech} data, most of the MTL MLP dataset configurations outperform the baselines in terms of recall while struggling in the precision score.
