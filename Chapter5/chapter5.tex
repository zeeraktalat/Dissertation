...
% TODO Add table of auxiliary task classifier configurations.
\begin{table}[]
  \centering
  \begin{tabular}{lll}
                                         & Regulariser & Regularisation Strength \\
    Offence Auxiliary Classifier         & L2          & 0.2                     \\
    Hate Speech Auxiliary Classifier     & L2          & 0.1                     \\
    Toxicity Auxiliary Classifier        & L2          & 0.1                     \\
    Hate Expert Auxiliary Classifier     & L2          & 0.5                     \\
    Sarcasm Auxiliary Classifier         & L2          & 0.1                     \\
    Argument Basis Auxiliary Classifier  & L2          & 0.1                     \\
    Moral Sentiment Auxiliary Classifier & L2          & 0.1
  \end{tabular}
