...
\zw{CODING: Rerun MLP hyper-param search.}
...
\zw{CODING: Run LSTM hyper-param search.}
...
\zw{Describe training regime}
We use the same training regime for all multi-task learning models,

- randomly select task
- weight losses for tasks
- - multiply with 1+ to avoid vanishing losses
