...
Please see \autoref{fig:mtl_mlp} and \autoref{fig:mtl_lstm} for illustration of the multi-task Multi-Layered Perceptron and multi-task Long-Short Term Memory network.
