...
In relation to the classification scores achieved by the best model for the \textit{Toxicity} dataset in \cref{chap:liwc}, the best performing model selected by highest \texttt{F1-score} is a LSTM model that uses word tokens as its input, score, obtains $0.9510$ in \texttt{accuracy}, $0.8047$ in \texttt{precision}, $0.9058$ in \texttt{recall}, and $0.8357$ in \texttt{F1-score}.\footnote{The scores here are the mean score over five different configurations of the random seeds.}
