...
A step to achieving this goal is to analyse how the subjective embodiments of the designers are embedded in the machine learning process, such that decisions can be made which are aligned with the subjectivities of the people using the models, \ZTedit{i.e. machine learning models should be trained on data from specific groups and designed for the use of those groups}.
