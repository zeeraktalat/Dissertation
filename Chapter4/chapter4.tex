...
\begin{figure}
  ...
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[0.48\textwidth]{waseem_train_time}
    \caption{Training time for each model type on the \textit{Hate Expert} dataset.}
    \label{fig:waseem_train_time}
    \vfill
    \includegraphics[0.48\textwidth]{waseem_hovy_train_time}
    \caption{Training time for each model type on the \textit{Hate Expert} dataset.}
    \label{fig:waseem_hovy_train_time}
  \end{minipage}
  \centering
  \includegraphics[0.48\textwidth]{garcia_train_time}
