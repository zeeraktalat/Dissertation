...
In reviewing \autoref{tab:vocab_sizes}, it is clear that computing LIWC representations and BPE representations of the documents results in smaller vocabulary sizes for all datasets with the exception of the BPE representation of the \textit{StormFront} dataset where the vocabulary grows. It is unsurprising that the vocabulary size would grow using BPE as subwords for all unrecognised words are computed. More surprising are the large drops in BPE vocabulary sizes for the remaining datasets. These drops suggest that a large set of the words that are unrecognised by the pre-trained Byte-Pair Embeddings in as complete words share a relatively small set of subwords.
There are two implications of this vocabulary reduction, a) resulting models are likely to be trained faster and have a smaller memory footprint than their word-based counter-parts and b) the embedding layer trained on the tokens will have a smaller vocabulary that it needs to learn and will have a higher frequency for many of the remaining tokens.
...
\zw{Fill out tables of token differences}
\begin{table}[htb]
\centering
...
\begin{tabular}{lllll}
  ...
  Offence     & $24$      & $150$   & $677$        & $851$\\
  Toxicity    &           &         &              & \\
  Hate Expert & $241$     & $25$    & $473$        & $739$  \\
  Hate Speech & $116$     & $47$    & $674$        & $837$\\
  StormFront  & $74$      & $117$   & $431$        & $622$
\end{tabular}%
}
...
\begin{tabular}{lllll}
               & Not Abuse & Abuse   & Intersection & Vocab size\\\hline
  Offence      & $3,303$   & $8,656$ & $4,809$      & $16,768$\\
  Toxicity     & $71,491$  & $1,560$ & $22,659$     & $95,710$\\
  Hate Expert  & $6,155$   & $953$   & $2,002$      & $9,110$\\
  Hate Speech  & $7,042$   & $2,599$ & $5,089$      & $14,730$\\
  StormFront   & $1,834$   & $2,273$ & $1,459$      & $5,566$
\end{tabular}%
}
\centering
...
\begin{tabular}{lllll}
              & Not Abuse & Abuse   & Intersection & Vocab size\\\hline
  Offence     & $7,978$   & $3,199$ & $5,486$      & $16,663$\\
  Toxicity    & $71,493$  & $1,560$ & $22,659$     & $95,712$\\
  Hate Expert & $6,231$   & $971$   & $1,979$      & $9,181$\\
  Hate Speech & $7,074$   & $2,653$ & $5,107$      & $14,834$\\
  StormFront  & $1,804$   & $2,240$ & $1,466$      & $5,510$
\end{tabular}%
}
...
Considering Tables \ref{tab:liwc_vocab_overlaps}, \ref{tab:word_vocab_overlaps}, and \ref{tab:bpe_vocab_overlaps}, some interesting developments are made clear, confirming some hypothesis.
