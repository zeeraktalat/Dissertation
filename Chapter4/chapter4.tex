...
\zw{Make this fit in}
The question of whether the time consumed by LIWC-based modelling, whether it is less or more than surface token-based models, can be reframed as a question of in-domain validity or generalisability onto an unseen sample. As the goal for machine learning models is ultimately to generalise onto unseen data, where the distributions of data may not mirror those that the models have been trained on, one might prefer the LIWC-based models that generalise well onto other datasets. However, in development of mahcine learning models, 
