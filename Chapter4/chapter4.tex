...
As I can establish that neural network methods are in fact appropriate, I turn to ask what the influence of recurrence is on the performance of models when prediction on in-domain and out-of-domain datasets. 
