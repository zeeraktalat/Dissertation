...
Most relevantly, \citet{Nina-Alcocer:2019} show that using information obtained through the LIWC dictionary can aid in classification of misogyny, in particular when used in combination with other feature representations such as word-level n-grams.
...
% TODO Mention that most commonly SVMs and LRs are used & Mention GATE team's work.
SVM \cite{Joksimovic:2019}
LR \cite{Davidson:2017,Waseem-Hovy:2016}
