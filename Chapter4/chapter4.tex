...
\begin{landscape}
  \begin{figure}
    \includegraphics[width=0.7\paperheight]{all_mlp_davidson_test.pdf}
  ...
  \hfill
  \begin{figure}
    \includegraphics[width=0.7\paperheight]{all_models_wulczyn_test.pdf}
  ...
  \hfill
  \begin{figure}
    \includegraphics[width=0.7\paperheight]{all_mlp_waseem_test.pdf}
...
\hfill
\begin{figure}
  \includegraphics[width=0.7\paperheight,height=\textwidth]{all_mlp_waseem_hovy_test.pdf}
...
hfill
\begin{figure}
  \includegraphics[width=0.7\paperheight]{all_mlp_garcia_test.pdf}
