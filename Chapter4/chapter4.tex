...
\zw{Update \cref{fig:davidson_dev_accuracy,fig:davidson_dev_loss,fig:davidson_dev_precision,fig:davidson_dev_recall,fig:davidson_dev_f1}
\cref{fig:wulczyn_dev_accuracy,fig:wulczyn_dev_loss,fig:wulczyn_dev_precision,fig:wulczyn_dev_recall,fig:wulczyn_dev_f1}
\cref{fig:waseem_dev_accuracy,fig:waseem_dev_loss,fig:waseem_dev_precision,fig:waseem_dev_recall,fig:waseem_dev_f1}
\cref{fig:waseem_hovy_dev_accuracy,fig:waseem_hovy_dev_loss,fig:waseem_hovy_dev_precision,fig:waseem_hovy_dev_recall,fig:waseem_hovy_dev_f1}
\cref{fig:garcia_dev_accuracy,fig:garcia_dev_loss,fig:garcia_dev_precision,fig:garcia_dev_recall,fig:garcia_dev_f1} when models have rerun}
\afterpage{
\begin{landscape}
\begin{table}[b]
\centering
...
\zw{Add model evaluation set performances as figures}

\begin{figure}
  \centering
    \centering
    \includegraphics[width=\textwidth]{davidson_dev_accuracy.png}
    \caption{In-domain accuracy on validation set for models trained on the \textit{Offence} dataset. The error represent the standard deviation over five runs.}
    \label{fig:davidson_dev_accuracy}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{davidson_dev_precision.png}
    \caption{In-domain precision on validation set for models trained on the \textit{Offence} dataset. The error represent the standard deviation over five runs.}
    \label{fig:davidson_dev_precision}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{davidson_dev_recall.png}
    \caption{In-domain recall on validation set for models trained on the \textit{Offence} dataset. The error represent the standard deviation over five runs.}
    \label{fig:davidson_dev_recall}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{davidson_dev_f1.png}
    \caption{In-domain macro F1-score on validation set for models trained on the \textit{Offence} dataset. The error represent the standard deviation over five runs.}
    \label{fig:davidson_dev_f1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{davidson_dev_loss_stderr_logscale.png}
    \caption{Validation losses for models trained on the \textit{Offence} dataset. Note that this figure is in a logarithmic scale, and standard error is displayed.}
...
\begin{figure}
  \centering
    \centering
    \includegraphics[width=\textwidth]{wulczyn_dev_accuracy.png}
    \caption{In-domain accuracy on validation set for models trained on the \textit{Toxicity} dataset. The error represent the standard deviation over five runs.}
    \label{fig:wulczyn_dev_accuracy}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{wulczyn_dev_precision.png}
    \caption{In-domain precision on validation set for models trained on the \textit{Toxicity} dataset. The error represent the standard deviation over five runs.}
    \label{fig:wulczyn_dev_precision}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{wulczyn_dev_recall.png}
    \caption{In-domain recall on validation set for models trained on the \textit{Toxicity} dataset. The error represent the standard deviation over five runs.}
    \label{fig:wulczyn_dev_recall}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{wulczyn_dev_f1.png}
    \caption{In-domain macro F1-score on validation set for models trained on the \textit{Toxicity} dataset. The error represent the standard deviation over five runs.}
    \label{fig:wulczyn_dev_f1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{wulczyn_dev_loss_stderr_logscale.png}
    \caption{Validation losses for models trained on the \textit{Toxicity} dataset. Note that this figure is in a logarithmic scale, and standard error is displayed.}
...
\begin{figure}
  \centering
    \centering
    \includegraphics[width=\textwidth]{waseem_dev_accuracy.png}
    \caption{In-domain accuracy on validation set for models trained on the \textit{Hate Expert} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_dev_accuracy}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_dev_precision.png}
    \caption{In-domain precision on validation set for models trained on the \textit{Hate Expert} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_dev_precision}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_dev_recall.png}
    \caption{In-domain recall on validation set for models trained on the \textit{Hate Expert} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_dev_recall}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_dev_f1.png}
    \caption{In-domain macro F1-score on validation set for models trained on the \textit{Hate Expert} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_dev_f1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_dev_loss_stderr_logscale.png}
    \caption{Validation losses for models trained on the \textit{Hate Expert} dataset. Note that this figure is in a logarithmic scale, and standard error is displayed.}
...
\begin{figure}
  \centering
    \centering
    \includegraphics[width=\textwidth]{waseem_hovy_dev_accuracy.png}
    \caption{In-domain accuracy on validation set for models trained on the \textit{Hate Speech} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_hovy_dev_accuracy}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_hovy_dev_precision.png}
    \caption{In-domain precision on validation set for models trained on the \textit{Hate Speech} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_hovy_dev_precision}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_hovy_dev_recall.png}
    \caption{In-domain recall on validation set for models trained on the \textit{Hate Speech} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_hovy_dev_recall}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_hovy_dev_f1.png}
    \caption{In-domain macro F1-score on validation set for models trained on the \textit{Hate Speech} dataset. The error represent the standard deviation over five runs.}
    \label{fig:waseem_hovy_dev_f1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{waseem_hovy_dev_loss_stderr_logscale.png}
    \caption{Validation losses for models trained on the \textit{Hate Speech} dataset. Note that this figure is in a logarithmic scale, and standard error is displayed.}
...
\begin{figure}
  \centering
    \centering
    \includegraphics[width=\textwidth]{garcia_dev_accuracy.png}
    \caption{In-domain accuracy on validation set for models trained on the \textit{StormFront} dataset. The error represent the standard deviation over five runs.}
    \label{fig:garcia_dev_accuracy}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{garcia_dev_precision.png}
    \caption{In-domain precision on validation set for models trained on the \textit{StormFront} dataset. The error represent the standard deviation over five runs.}
    \label{fig:garcia_dev_precision}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{garcia_dev_recall.png}
    \caption{In-domain recall on validation set for models trained on the \textit{StormFront} dataset. The error represent the standard deviation over five runs.}
    \label{fig:garcia_dev_recall}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{garcia_dev_f1.png}
    \caption{In-domain macro F1-score on validation set for models trained on the \textit{StormFront} dataset. The error represent the standard deviation over five runs.}
    \label{fig:garcia_dev_f1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{garcia_dev_loss_stderr_logscale.png}
    \caption{Validation losses for models trained on the \textit{StormFront} dataset. Note that this figure is in a logarithmic scale, and standard error is displayed.}
...
In the space left by the

\zw{Start by talking about performance on development sets}
\zw{Then talk about performance on test set}
