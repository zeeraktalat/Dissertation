...
The datasets I use are the \textit{Stormfront} dataset~\citep{Garcia:2019}, the \textit{Offence} dataset~\citep{Davidson:2017}, the \textit{Hate Speech} dataset~\citep{Waseem-Hovy:2016}, the \textit{Expert Hate} dataset~\citep{Waseem:2016}, and finally the \textit{Toxicity} dataset~\citep{Wulczyn:2017}.
