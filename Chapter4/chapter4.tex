...
\begin{minipage}{0.42\paperheight}
    ...
    \begin{tabular}{ll|ll|ll|ll}
      ...
      \multirow{4}{*}{\it{Offence}}      & Accuracy  & 0.9504                   & \textbf{0.9544} & 0.9484                  & 0.9504          & 0.9399          & 0.9407          \\
                                    & Precision & 0.9098                   & \textbf{0.9140} & 0.9064                  & 0.9073          & 0.8772          & 0.8755          \\
                                    & Recall    & 0.9137                   & 0.9257          & 0.9095                  & 0.9174          & 0.9275          & \textbf{0.9385} \\
                                    & F1-score  & 0.9118                   & \textbf{0.9197} & 0.9079                  & 0.9123          & 0.8995          & 0.9025          \\ \hline
      \multirow{4}{*}{Toxicity}     & Accuracy  & 0.8319                   & 0.8311          & 0.8882                  & 0.8904          & \textbf{0.9342} & 0.9308          \\
                                    & Precision & 0.6505                   & 0.6467          & 0.7055                  & 0.7077          & \textbf{0.8108} & 0.7988          \\
                                    & Recall    & 0.7941                   & 0.7828          & 0.8006                  & 0.7949          & 0.8062          & \textbf{0.8067} \\
                                    & F1-score  & 0.6800                   & 0.6752          & 0.7393                  & 0.7397          & \textbf{0.8085} & 0.8027          \\ \hline
      \multirow{4}{*}{Hate Expert}  & Accuracy  & 0.6416                   & 0.6792          & 0.6922                  & 0.7413          & 0.7630          & \textbf{0.7688} \\
                                    & Precision & 0.4892                   & 0.4927          & 0.5223                  & 0.5365          & \textbf{0.5738} & 0.5685          \\
                                    & Recall    & 0.4832                   & 0.4899          & 0.5316                  & 0.5416          & \textbf{0.5857} & 0.5737          \\
                                    & F1-score  & 0.4748                   & 0.4864          & 0.5193                  & 0.5381          & \textbf{0.5783} & 0.5708          \\ \hline
      \multirow{4}{*}{Hate Speech}  & Accuracy  & 0.6413                   & 0.6519          & 0.6294                  & 0.6554          & \textbf{0.6738} & 0.6696          \\
                                    & Precision & 0.5835                   & 0.5834          & 0.5565                  & 0.5778          & \textbf{0.5941} & 0.5838          \\
                                    & Recall    & \textbf{0.5810}          & 0.5722          & 0.5503                  & 0.5601          & 0.5564          & 0.5475          \\
                                    & F1-score  & \textbf{0.5820}          & 0.5741          & 0.5510                  & 0.5597          & 0.5490          & 0.5364          \\ \hline
      \multirow{4}{*}{StormFront}   & Accuracy  & 0.5879                   & 0.5921          & 0.5795                  & \textbf{0.6172} & 0.5000          & 0.5314          \\
                                    & Precision & 0.5887                   & 0.5946          & 0.5798                  & \textbf{0.6181} & 0.5000          & 0.5705          \\
                                    & Recall    & 0.5879                   & 0.5921          & 0.5795                  & \textbf{0.6172} & 0.5000          & 0.5314          \\
                                    & F1-score  & 0.5869                   & 0.5893          & 0.5791                  & \textbf{0.6164} & 0.4226          & 0.4559
    \end{tabular}%
    }
    ...
    \begin{tabular}{ll|ll|ll|ll}
                                      &           & \multicolumn{2}{c|}{Word} & \multicolumn{2}{c|}{BPE} & \multicolumn{2}{c}{LIWC} \\
                                 &           & LR          & SVM        & LR         & SVM        & LR          & SVM        \\ \hline
    \multirow{4}{*}{Offence}     & Accuracy  & 0.6414      & 0.7019     & 0.6563     & 0.6962     & 0.8072      & \textbf{0.8665}     \\
                                 & Precision & 0.6442      & 0.6609     & 0.6501     & 0.6636     & 0.7291      & \textbf{0.7763}     \\
                                 & Recall    & 0.7576      & 0.7825     & 0.7686     & 0.7897     & 0.8736      & \textbf{0.9083}     \\
                                 & F1-score  & 0.5983      & 0.6459     & 0.6109     & 0.6437     & 0.7496      & \textbf{0.8116}     \\ \hline
    \multirow{4}{*}{\it{Toxicity}}    & Accuracy  & 0.9577      & \textbf{0.9577}     & 0.9584     & 0.9583     & 0.9530      & 0.9549     \\
                                 & Precision & 0.9058      & 0.8961     & 0.9052     & 0.9015     & 0.9135      & \textbf{0.9210}     \\
                                 & Recall    & 0.8352      & \textbf{0.8478}     & 0.8406     & 0.8446     & 0.7952      & 0.8008     \\
                                 & F1-score  & 0.8662      & 0.8700     & 0.8693     & \textbf{0.8703}     & 0.8420      & 0.8484     \\ \hline
    \multirow{4}{*}{Hate Expert} & Accuracy  & 0.8020      & 0.8035     & \textbf{0.8353}     & 0.8309     & 0.8309      & 0.8309     \\
                                 & Precision & 0.4834      & 0.5111     & \textbf{0.6325}     & 0.6131     & 0.6167      & 0.6262     \\
                                 & Recall    & 0.4929      & 0.5053     & 0.5513     & 0.5449     & 0.5524      & \textbf{0.5640}     \\
                                 & F1-score  & 0.4786      & 0.4974     & 0.5582     & 0.5493     & 0.5600      & \textbf{0.5750}     \\ \hline
    \multirow{4}{*}{Hate Speech} & Accuracy  & 0.6761      & 0.6767     & 0.6684     & 0.6690     & 0.6785      & \textbf{0.6838}     \\
                                 & Precision & 0.5876      & 0.5916     & 0.5606     & 0.5650     & 0.5925      & \textbf{0.6099}     \\
                                 & Recall    & 0.5325      & 0.5378     & 0.5217     & 0.5246     & 0.5325      & \textbf{0.5423}     \\
                                 & F1-score  & 0.5023      & 0.5130     & 0.4866     & 0.4925     & 0.5005      & \textbf{0.5167}     \\ \hline
    \multirow{4}{*}{StormFront}  & Accuracy  & 0.5544      & 0.5649     & \textbf{0.5649}     & 0.5628     & 0.5126      & 0.5146     \\
                                 & Precision & 0.6697      & 0.6645     & \textbf{0.6829}     & 0.6675     & 0.5866      & 0.5799     \\
                                 & Recall    & 0.5544      & 0.5649     & \textbf{0.5649}     & 0.5628     & 0.5126      & 0.5146     \\
                                 & F1-score  & 0.4632      & \textbf{0.4872}     & 0.4811     & 0.4817     & 0.3800      & 0.3901    
    \end{tabular}%
    }
...
\multirow{4}{*}{Offence}             & Accuracy  & 0.2929 & 0.2945 & 0.2912 & 0.3142 & 0.4248 & \textbf{0.6821} \\
